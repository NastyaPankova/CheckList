...
public class ApiSettings : IApiSettings
{
    ...
    public ApiSettings(ISettingsSource source, IIdentityServerConnectSettings identityServerSettings, 
                       IGeneralSettings generalSettings, IDbSettings dbSettings)
    {
        this.source = source;
